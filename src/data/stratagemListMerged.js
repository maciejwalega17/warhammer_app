...
import deamonsKhorne from './deamonsKhorne.json';
import deamonsNurgle from './deamonsNurgle.json';
import deamonsSlaanesh from './deamonsSlaanesh.json';
import deamonsTzeentch from './deamonsTzeentch.json';
import astraMilitarum from './astraMilitarum.json';
